...
class WPPoints_Users_List_Table extends WP_List_Table {
    /**
	...
	function column_cb($item) {
		return sprintf(
			'<label class="screen-reader-text" for="user_' . $item['user_id'] . '">' . sprintf( __( 'Select %s' ), $item['user_id'] ) . '</label>'
			."<input type='checkbox' name='users[]' id='user_{$item['user_id']}' value='{$item['user_id']}' />"
		);
	}
}